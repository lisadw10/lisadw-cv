...
<div className="site-wrap">
  ...
  <aside style={{backgroundImage: `url(${websiteData.dbWeb[0].Home.img})`}} />
  <main>
    <h1 className="mb-0">{websiteData.dbWeb[0].Home.title}</h1>
    <div className="mb-5">
      <p className="lead mb-3">{websiteData.dbWeb[0].Home.desc}</p>
      <p>{websiteData.dbWeb[0].Home.items[0].value}</p>
      <p>{websiteData.dbWeb[0].Home.items[1].value}</p>
    </div>
    <p>
      <a href={websiteData.dbWeb[0].Navbar.social[0].url} className="mr-2 mb-2">Twitter</a>
      <a href={websiteData.dbWeb[0].Navbar.social[1].url} className="mr-2 mb-2">Facebook</a>
      <a href={websiteData.dbWeb[0].Navbar.social[2].url} className="mr-2 mb-2">Instagram</a> 
    </p>
